                                ...
                                <Row>
                                    ...
                                    <Col>
                                        ...
                                        <Form.Group className="mb-3" controlId="embarazo">
                                            ...
                                            <Form.Select onChange={handleChange} value={infoDetalleAux.embarazo} name="embarazo">
                                    ...
                                    <Col>
                                        ...
                                        <Form.Group className="mb-3" controlId="crecimiento">
                                            ...
                                            <Form.Select onChange={handleChange} value={infoDetalleAux.crecimiento} name="crecimiento">
